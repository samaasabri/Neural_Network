...
choise = 1
x_train1, x_test1, y_train1, y_test1 = Split_my_data(choice=choise, feature1="MinorAxisLength", feature2="Perimeter")

w_Adaline = Adaline(x_train1, y_train1, 0.01, 10000)

w_perceptron = perceptron(x_train1, y_train1, 0.001, 10000)



y_Adaline = (test_fn(x_test1, w_Adaline, 0))
y_perceptron = (test_fn(x_test1, w_perceptron, 0))
